 ...
 */
public class HRingView extends View {
    ...
    public HRingView(Context context) {
        this(context, null);
    }

    public HRingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HRingView(Context context, AttributeSet attrs, int defStyleAttr) {
