...
public class StringClass {
    ...
    public static String Heart_rate_normal = "您的心率趋于正常范围";
    ...
    public static String Blood_pressure_normal = "您的血压趋于正常范围";
    ...
    public static String Body_weight_normal = "您的体重趋于正常范围";
    ...
    public static String Oxygen_low = "血氧饱和度低可见于贫血，肺功能障碍，通气功能障碍等，建议去医院呼吸科检查明确，平时多吃红枣，枸杞等补血的食物，" +
            "适当输氧等，保持环境通风。";
    public static String Oxygen_normal = "您的血氧饱和度趋于正常范围";

    public static String Body_temperature_high = "您的体温高于正常范围,有发烧的症状,如身体感觉不适,强烈建议您及时就医!";
    public static String Body_temperature_low = "您的体温低于正常范围";
