...
import com.example.heath.adpter.PopupWindowAdapter;
...
public class ShowUtils {
    ...
    private static void createPopupWindow(Activity activity, View targetView,
        ...
        view = activity.getLayoutInflater().inflate(R.layout.newslist, null);
    ...
    public static void showPopupWindow(Activity activity, View targetView, int width, int height,
        ...
        ListView lvOptions = (ListView) view.findViewById(R.id.news_list);
